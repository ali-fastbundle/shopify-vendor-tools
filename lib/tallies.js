...
export const TALLIES = [
  ...
  /* Kept apart from "received" on purpose. That counter answers "how many
     people asked", and a name we lifted off a competitor's comparison page was
     not asked for by anybody. Folding it in would make the label wrong. */
  ["suggestions:discovered", "from discovery"],
